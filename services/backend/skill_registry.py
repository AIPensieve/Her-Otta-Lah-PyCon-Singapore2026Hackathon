"""
Skill Registry — 8 fixed skills for Demo stability.
All AI recommendations reference skill_id. Pages use these steps directly,
bypassing AI generation for guaranteed stable output.
"""
...
SKILLS: dict[str, dict] = {
    "breathing_60s": {
        ...
        "steps": [
            {"step_id": "b1", "name_zh": "放松", "name_en": "Relax",
             "duration_seconds": 15,
            ...
            {"step_id": "b2", "name_zh": "吸气", "name_en": "Inhale",
             "duration_seconds": 15,
            ...
            {"step_id": "b3", "name_zh": "呼气", "name_en": "Exhale",
             "duration_seconds": 15,
            ...
            {"step_id": "b4", "name_zh": "完成", "name_en": "Done",
             "duration_seconds": 15,
        ...
        "completion_record_template": {
            ...
            "mood_tags": [], "body_tags": [], "related_action": "60 秒呼吸",
        },
    },
    ...
    "night_calm": {
        ...
        "steps": [
            {"step_id": "n1", "name_zh": "安定", "name_en": "Settle",
             "duration_seconds": 60,
            ...
            {"step_id": "n2", "name_zh": "放松", "name_en": "Release",
             "duration_seconds": 60,
            ...
            {"step_id": "n3", "name_zh": "陪伴", "name_en": "Together",
             "duration_seconds": 60,
        ...
        "completion_record_template": {
            ...
            "tags": ["night_calm", "sleep", "calm"],
            "mood_tags": [], "body_tags": ["夜醒"], "related_action": "夜里陪伴",
        },
    },
    ...
    "hot_flash_calm": {
        ...
        "steps": [
            {"step_id": "h1", "name_zh": "冷静", "name_en": "Cool Down",
             "duration_seconds": 30,
            ...
            {"step_id": "h2", "name_zh": "呼吸", "name_en": "Breathe",
             "duration_seconds": 30,
            ...
            {"step_id": "h3", "name_zh": "关注", "name_en": "Notice",
             "duration_seconds": 30,
            ...
            {"step_id": "h4", "name_zh": "完成", "name_en": "Done",
             "duration_seconds": 30,
        ...
        "completion_record_template": {
            ...
            "tags": ["hot_flash", "menopause", "calm"],
            "mood_tags": [], "body_tags": ["潮热"], "related_action": "潮热后缓一缓",
        },
    },
    ...
    "emotion_overload": {
        ...
        "steps": [
            {"step_id": "e1", "name_zh": "停下来", "name_en": "Stop",
             "duration_seconds": 30,
            ...
            {"step_id": "e2", "name_zh": "呼吸", "name_en": "Breathe",
             "duration_seconds": 30,
            ...
            {"step_id": "e3", "name_zh": "接受", "name_en": "Accept",
             "duration_seconds": 30,
        ...
        "completion_record_template": {
            ...
            "tags": ["emotion", "anxiety", "calm"],
            "mood_tags": ["烦躁"], "body_tags": [], "related_action": "情绪很多时缓一缓",
        },
    },
    ...
    "neck_relax_3min": {
        ...
        "steps": [
            {"step_id": "nk1", "name_zh": "转肩", "name_en": "Shoulder Roll",
             "duration_seconds": 30,
            ...
            {"step_id": "nk2", "name_zh": "抬头", "name_en": "Head Lift",
             "duration_seconds": 30,
            ...
            {"step_id": "nk3", "name_zh": "侧颈", "name_en": "Neck Tilt",
             "duration_seconds": 30,
            ...
            {"step_id": "nk4", "name_zh": "摆臂", "name_en": "Arm Swing",
             "duration_seconds": 30,
            ...
            {"step_id": "nk5", "name_zh": "放松", "name_en": "Rest",
             "duration_seconds": 30,
            ...
            {"step_id": "nk6", "name_zh": "完成", "name_en": "Done",
             "duration_seconds": 30,
        ...
        "completion_record_template": {
            ...
            "tags": ["neck", "shoulder", "move"],
            "mood_tags": [], "body_tags": ["肩颈"], "related_action": "3 分钟肩颈放松",
        },
    },
    ...
    "gentle_stretch_5min": {
        ...
        "steps": [
            {"step_id": "gs1", "name_zh": "手臂拉伸", "name_en": "Arm Stretch",
             "duration_seconds": 60,
            ...
            {"step_id": "gs2", "name_zh": "侧弯", "name_en": "Side Bend",
             "duration_seconds": 60,
            ...
            {"step_id": "gs3", "name_zh": "腰部", "name_en": "Waist Twist",
             "duration_seconds": 60,
            ...
            {"step_id": "gs4", "name_zh": "小腿", "name_en": "Calf Raise",
             "duration_seconds": 60,
            ...
            {"step_id": "gs5", "name_zh": "放松", "name_en": "Rest",
             "duration_seconds": 60,
        ...
        "completion_record_template": {
            ...
            "tags": ["stretch", "full_body", "gentle"],
            "mood_tags": [], "body_tags": [], "related_action": "5 分钟轻量拉伸",
        },
    },
    ...
    "knee_friendly_move": {
        ...
        "steps": [
            {"step_id": "kn1", "name_zh": "坐姿热身", "name_en": "Seated Warmup",
             "duration_seconds": 30,
            ...
            {"step_id": "kn2", "name_zh": "踝转", "name_en": "Ankle Circle",
             "duration_seconds": 30,
            ...
            {"step_id": "kn3", "name_zh": "抬腿", "name_en": "Leg Lift",
             "duration_seconds": 30,
            ...
            {"step_id": "kn4", "name_zh": "手臂", "name_en": "Arm Circles",
             "duration_seconds": 30,
            ...
            {"step_id": "kn5", "name_zh": "放松", "name_en": "Rest",
             "duration_seconds": 60,
        ...
        "completion_record_template": {
            ...
            "tags": ["knee", "gentle", "seated"],
            "mood_tags": [], "body_tags": ["膝盖", "腿"], "related_action": "膝盖友好动作",
        },
    },
    ...
    "sleep_stretch": {
        ...
        "steps": [
            {"step_id": "ss1", "name_zh": "躺下", "name_en": "Lie Down",
             "duration_seconds": 30,
            ...
            {"step_id": "ss2", "name_zh": "腿部", "name_en": "Knee Hug",
             "duration_seconds": 60,
            ...
            {"step_id": "ss3", "name_zh": "脊背", "name_en": "Spine Twist",
             "duration_seconds": 60,
            ...
            {"step_id": "ss4", "name_zh": "放松", "name_en": "Drift Off",
             "duration_seconds": 90,
        ...
        "completion_record_template": {
            ...
            "summary": "完成了睡前舒缓拉伸练习。",
            "tags": ["sleep", "stretch", "bedtime"],
            "mood_tags": [], "body_tags": [], "related_action": "睡前舒缓拉伸",
        },
    },
}

SKILLS["heel_drop_game_60s"] = {
    **SKILLS["gentle_stretch_5min"],
    ...
    "steps": [
        {"step_id": "hd1", "name_zh": "扶稳", "name_en": "Hold Support",
         "duration_seconds": 15,
        ...
        {"step_id": "hd2", "name_zh": "轻落", "name_en": "Drop Gently",
         "duration_seconds": 30,
        ...
        {"step_id": "hd3", "name_zh": "停下", "name_en": "Rest",
         "duration_seconds": 15,
    ...
    "completion_record_template": {
        "kind": "action", "title": "60 秒踮脚小游戏",
        "summary": "完成了 60 秒轻量踮脚小游戏。",
        "tags": ["game", "heel_drop", "move"],
        "mood_tags": [], "body_tags": [], "related_action": "60 秒踮脚小游戏",
    },
}

SKILLS["neck_relax_game_60s"] = {
    **SKILLS["neck_relax_3min"],
    ...
    "completion_record_template": {
        "kind": "action", "title": "60 秒肩颈小游戏",
        "summary": "完成了 60 秒肩颈放松小游戏。",
        "tags": ["game", "neck", "shoulder", "move"],
        "mood_tags": [], "body_tags": ["肩颈"], "related_action": "60 秒肩颈小游戏",
    },
}

SKILL_ALIASES: dict[str, str] = {
    # IDs from the newer AI/RAG contract. Keep canonical demo IDs stable.
...
def normalize_skill_id(skill_id: str | None) -> str | None:
    if not skill_id:
        return None
...
def get_skill(skill_id: str) -> dict | None:
    ...
    return SKILLS.get(normalized) if normalized else None
