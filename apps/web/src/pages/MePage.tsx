...
export function MePage() {
  ...
  const coming = () => setModal({ title: t.common.comingSoon, desc: t.common.comingSoonDesc });
  ...
  return (
    <div className="me-page">
      ...
      {/* ── Avatar Card ── */}
      <button className="me-avatar-card" onClick={() => setModal({ title: t.me.deviceDetail, desc: t.me.deviceDetailDesc })}>
      ...
      <div className="me-settings-list">
        ...
        <button className="me-setting-item" onClick={coming}>
      ...
      {/* ── Feedback Button ── */}
      <button className="me-feedback-btn" onClick={coming}>
