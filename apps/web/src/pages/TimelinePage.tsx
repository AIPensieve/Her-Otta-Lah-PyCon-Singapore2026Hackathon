      ...
      <div className="tl-header-card">
        <div className="tl-header-top">
          ...
          <button
            ...
            onClick={() => setModal({ title: t.common.comingSoon, desc: t.common.comingSoonDesc })}
          >
        ...
        <div className="tl-action-buttons">
          <button
            className="tl-action-btn tl-action-body"
            onClick={() => setModal({ title: tl.recordBodyTitle, desc: tl.recordBodyModalDesc })}
          >
          ...
          <button
            className="tl-action-btn tl-action-mood"
            onClick={() => setModal({ title: tl.recordMoodTitle, desc: tl.recordMoodModalDesc })}
          >
            <div className="tl-action-icon">
      ...
      <div className="tl-container">
        ...
        <div className="tl-list">
          ...
          <div className="tl-item">
            ...
            <button
              className="tl-card"
              onClick={() => setModal({ title: tl.tag_body, desc: tl.item1_desc })}
            >
          ...
          <div className="tl-item">
            ...
            <button
              className="tl-card"
              onClick={() => setModal({ title: tl.tag_mood, desc: tl.item2_desc })}
            >
              <div className="tl-card-content">
                <h3>{tl.tag_mood}</h3>
                <p>{tl.item2_desc}</p>
          ...
          <div className="tl-item">
            ...
            <button
              className="tl-card"
              onClick={() => setModal({ title: tl.tag_move, desc: tl.item3_desc })}
            >
              <div className="tl-card-content">
                <h3>{tl.tag_move}</h3>
                <p>{tl.item3_desc}</p>
          ...
          <div className="tl-item">
            ...
            <button
              className="tl-card"
              onClick={() => setModal({ title: tl.tag_breathe, desc: tl.item4_desc })}
            >
              <div className="tl-card-content">
          ...
          <div className="tl-item">
            ...
            <button
              className="tl-card"
              onClick={() => setModal({ title: tl.tag_sleep, desc: tl.item5_desc })}
            >
              <div className="tl-card-content">
                <h3>{tl.tag_sleep}</h3>
                <p>{tl.item5_desc}</p>
